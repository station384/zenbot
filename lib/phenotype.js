...
let PROPERTY_RANDOM_CHANCE = 0.40 // Chance of a Mutation to spawn a new species
...
module.exports = {
  ...
  fitness: function(phenotype) {
    ...
    var vsBuyHoldRate = phenotype.sim.endBalance//((phenotype.sim.roi + 100) / 50)
    // if minTrades is set use an alternate fitness calculation to hone in on a trade stratagy that has the minimum trade count
    // once found use the normal fitness strategy to find the best parameters.
